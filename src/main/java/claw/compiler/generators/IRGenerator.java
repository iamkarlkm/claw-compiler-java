...
import com.claw.compiler.annotation.SystemAnnotations;
import com.claw.compiler.context.SemanticContext;
import com.claw.compiler.context.StructureContext;
import com.claw.compiler.context.StructureContext.BlockNode;
...
public class IRGenerator {
    ...
    public static class IRProgram {
        ...
        private final List<FlowAnnotation> flowAnnotations; // 操作流注解
        private final List<HookAnnotation> hookAnnotations; // 钩子注解
        ...
        public void addFlowAnnotation(FlowAnnotation annotation) {
            flowAnnotations.add(annotation);
        }
        
        public void addHookAnnotation(HookAnnotation annotation) {
        ...
        public String toString() {
            ...
            if (!hookAnnotations.isEmpty()) {
                ...
                for (HookAnnotation hook : hookAnnotations) {
            ...
            if (!flowAnnotations.isEmpty()) {
                ...
                for (FlowAnnotation flow : flowAnnotations) {
