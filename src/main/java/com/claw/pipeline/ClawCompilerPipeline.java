...
import com.claw.compiler.annotation.ProgramAnnotations.AnnotationType;
import com.claw.compiler.context.SemanticContext;
import com.claw.compiler.context.StructureContext;
import com.claw.compiler.core.PreprocessedSource;
import com.claw.compiler.core.Preprocessor;
import com.claw.compiler.core.Token;
import com.claw.compiler.core.TokenStream;
import com.claw.compiler.core.Tokenizer;
import com.claw.compiler.generators.TypeChecker;
import com.claw.compiler.hierarchy.HierarchicalBlocks;
import com.claw.compiler.hierarchy.HierarchyBuilder;
import com.claw.compiler.pairer.PairingAnalyzer;
import com.claw.compiler.pairer.PairingResult;
import com.claw.compiler.processors.blocks.AnnotationBlockProcessor;
import com.claw.compiler.processors.blocks.AssignmentBlockProcessor;
import com.claw.compiler.processors.blocks.ControlFlowBlockProcessor;
import com.claw.compiler.processors.blocks.DeclarationBlockProcessor;
import com.claw.compiler.processors.blocks.ExpressionBlockProcessor;
import com.claw.compiler.processors.blocks.FunctionBlockProcessor;
import com.claw.compiler.processors.blocks.ModuleBlockProcessor;
import com.claw.compiler.processors.blocks.ScopeBlockProcessor;
import com.claw.compiler.processors.blocks.TypeBlockProcessor;
import com.claw.compiler.processors.semantic.ControlFlowProcessor;
import com.claw.compiler.processors.semantic.DeclarationProcessor;
import com.claw.compiler.processors.semantic.FunctionProcessor;
import com.claw.compiler.processors.semantic.LiteralProcessor;
import com.claw.compiler.processors.semantic.OperatorProcessor;
import com.claw.compiler.processors.semantic.TypeProcessor;
import com.claw.compiler.scanner.SourceScanner;
...
public class ClawCompilerPipeline {
    ...
    public CompilationResult compile(String sourceCode, String moduleName) {
        ...
        try {
            ...
            // 1.1 扫描整个文件
            com.claw.compiler.scanner.SourceView sourceView = sourceScanner.scan(sourceCode,null);
    ...
    private StructureContext runBlockProcessors(HierarchicalBlocks blocks,List<Token> tokens,
        ...
        CompletableFuture.allOf(f1, f2, f3, f4, f5, f6, f7, f8, f9).join();
    ...
    public static class Builder {
        ...
        public Builder withDefaultFrontend() {
            ...
            this.irGenerator = new IRGenerator(null);
            return this;
        }
